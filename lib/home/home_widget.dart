  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFE5B4A1),
                                    ...
                                    child: Container(
                                      height:
                                          MediaQuery.sizeOf(context).height *
                                              0.4,
                                      child: BtnEditWidget(
                                        pProduct: listViewProductosRecord,
                                      ),
                                    ),
                                  ),
                                );
                          ...
                          child: Slidable(
                            endActionPane: ActionPane(
                              ...
                              children: [
                                SlidableAction(
                                  label: 'Delete',
                                  backgroundColor: Color(0xFF981717),
